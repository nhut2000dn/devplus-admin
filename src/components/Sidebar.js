...
import { faBook, faBoxOpen, faChartPie, faUser, faCog, faFileAlt, faHandHoldingUsd, faSignOutAlt, faTable, faTimes, faCalendarAlt, faMapPin, faInbox, faRocket } from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <NavItem
                ...
                icon={faUser}
              />
              <CollapsableNavItem eventKey="/component" title="Components" icon={faBoxOpen}>
                <NavItem
                  title="Sidebar"
